...
public:
    const char* a = " ";
    const char* a1 = "day la const char * string 2.";
    int i, j;
    string b = a;
    string c = a1;
    
    void NhapString() {
        cout << "Nhap string 1: "; getline(cin, b);
        cout << "Do dai cua string 1: " << b.length();
        cout << "\nIn ra string 1: " << b;
        b.erase();
        cout << "\nXoa string 1 in ra duoc: " << b;
        cout << "\nNhap moi string 1: ";
        getline(cin, b);
        cout << "Dao string 1: ";
        ...
        cout << "\nDo dai moi cua string 1: " << b.length();
        cout << "\nIn string 2: " << a1;
        cout << "\nNhap moi string 2: ";
        getline(cin, c);
        cout << "In string 2: " << c;
        cout << "\nDo dai moi cua string 2: " << b.length();
        cout << "\nGhep voi string 1 : " << b + c;
        cout << "\nSo sanh 2 chuoi: ";
        if (b.length() == c.length()) {
            cout << "Hai chuoi bang nhau";
        }
        else if (b.length() >> c.length()) {
            cout << "Chuoi string 1 dai hon string 2.";
        }
        else cout << "Chuoi string 2 dai hon string 1.";
    }
